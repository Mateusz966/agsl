...
import DishListNavigationHeader from '../../components/organisms/DishListNavigationHeader/DishListNavigationHeader';
import {TabScenes} from '../TabNavigation/TabNavigation.types';
